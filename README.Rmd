...
Note that `greta` requires some additional dependencies. Please check [greta-stats.org/](https://greta-stats.org/) for more information. 

We also source some convenience functions to help prepare the data and building the model.  
