---
title: "GDUM: Simultaneusly modelling community dissimilarity and uniqueness"
output: github_document
---

This repository contains the code associated with the manuscript XXXXXXXXXXX et al. (2025). 
...
- `SI` contains code to replicate the figures in Supplementary Information
